	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        addSetButtom.setOnClickListener (new View.OnClickListener ()
        {
            public void onClick (View v)
            {
            	...
            	if(numOfReps.getText().toString().equals("") || numOfWeight.getText().toString().equals("")){
        ...
        saveSetButtom.setOnClickListener (new View.OnClickListener (){
            ...
            { 
        		...
        		if(workoutName.equals("")){
        			Toast.makeText(getApplicationContext(), "Please Enter Excercise Name!", 
        			...
        			Toast.makeText(getApplicationContext(), "Excercise has been added successfully!", 
